...
;------------------------------------------------------------------------
	...
	global day_of_week, is_leap_year, days_in_month, monthname, dayname
	include intmath.inc
...
dy_mon: db "Monday", 0
dy_tue: db "Tuesday", 0
dy_wed: db "Wednesday", 0
dy_thu: db "Thursday", 0
dy_fri: db "Friday", 0
dy_sat: db "Saturday", 0
